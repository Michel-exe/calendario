            ...
            <fieldset class="datos">
               ...
               <section class="inp inp-nor inp-icon">
                  ...
                  <div>
                     ...
                     <input class="inpEvent inpIco" type="tel" value="1234567890" required data-i="1" data-co="0" data-le="12" max="9999999999" maxlength="12">
                  </div>
                  <span> <b>0</b> / 12 </span>
               </section>
               <section class="inp inp-check ">
                  <input type="checkbox" name="" id="whats">
                  <label for="whats">Cuento con Whatsapp</label>
               </section>
               <section class="inp inp-terminos ">
                  <input type="checkbox" name="" id="terminos" require>
                  <label for="terminos" require>Acepta los <a>Terminos y Condiciones</a></label>
               </section>
            </fieldset>
